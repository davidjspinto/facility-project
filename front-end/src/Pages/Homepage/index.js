...
import { Navbar, Authentication, LegionellaEvaluation } from "../../Components";
            ...
            <div className="homepageDisplay">
                ...
                <div className="homepage-column2">
                    ...
                    <div className="homepage-btn-display">
                        <button className="contact-btn" type="button" onclick={startLegionellaAssessment}>Contact Us</button>
